...
public class ApiSecDummyScanRule extends AbstractAppParamPlugin {

    public static final String NULL_BYTE_CHARACTER = String.valueOf((char) 0);

    /** Prefix for internationalised messages used by this rule */
    private static final String MESSAGE_PREFIX = "ascanalpha.apisecdummy.";
    ...
    private static Logger log = LogManager.getLogger(ApiSecDummyScanRule.class);
